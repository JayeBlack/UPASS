...
import { Bell, DollarSign, FileText, Calendar, CheckCircle, AlertTriangle, Info } from "lucide-react";
...
const mockNotifications: Notification[] = [
  { id: "1", title: "Fee Payment Reminder", message: "You have an outstanding balance of GHS 1,600.00 for Semester 2, 2023/2024. Please settle before registration closes.", type: "fee", severity: "warning", date: "2026-02-14", read: false },
  ...
  { id: "3", title: "Exam Timetable Published", message: "The end-of-semester exam timetable for Semester 1, 2025/2026 has been published. Download it from the Exam Timetable page.", type: "exam", severity: "info", date: "2026-02-12", read: true },
  { id: "4", title: "Course Registration Deadline", message: "Course registration for Semester 1 closes on 28th February 2026. Ensure all courses are registered.", type: "general", severity: "warning", date: "2026-02-10", read: true },
  ...
  { id: "6", title: "Results Published", message: "Results for Semester 2, 2024/2025 have been published. Check your results page.", type: "general", severity: "info", date: "2026-01-20", read: true },
];
